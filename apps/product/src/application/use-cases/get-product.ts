// domain/product/application/use-cases/get-product.ts
import { Injectable } from '@nestjs/common';
import { Either, left, right } from 'apps/core/either';
import { ProductRepository } from '../repositories/produto-repository';
import { ResourceNotFoundError } from 'apps/core/erros/errors/resource-not-found-error';
